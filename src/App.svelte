<script>
  ...
  const steps = [
    ...
    "<p>Once again, incarcerated folks in <span style = 'color: #ff9f3f; font-weight: 600'>Alabama</span> have to work the most at the median prison wage in order to be able to afford this product. A typical pack of rice for people incarcerated in this state costs about <span style = 'color: #7695c4; font-weight: 600'>11 hours and 40 minutes</span> of labor. Contrastingly, with about <span style = 'color: #7695c4; font-weight: 600'>an hour</span> of labor at the median prison wage, folks incarcerated in <span style = 'color: #ff9f3f; font-weight: 600'>New Jersey</span> can purchase this same pack of rice.</p>",
    "<p>And finally, let's consider the ink <span style = 'color: #7695c4; font-weight: 600'>pen</span>. Crucial for learning, self-expression, and communicating with others,  the pen is an indispensable tool for day-to-day life both inside and outside of prison. So as valuable as this miscellaneous item is, what’s it cost for those incarcerated?</p>",
